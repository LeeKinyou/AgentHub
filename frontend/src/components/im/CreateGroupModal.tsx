...
export function CreateGroupModal({ isOpen, onClose, availableAgents, onCreate }: CreateGroupModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={onClose}>
      <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl w-[440px] shadow-2xl animate-in fade-in-50 zoom-in-95 duration-150" onClick={(e) => e.stopPropagation()}>
        ...
        />
        <p className="text-xs text-zinc-500 mb-2">选择要拉入群组的智能体：</p>
