  ...
  return (
    <>
      <MainLayout
        ...
        fileExplorer={s.state.activeProject && s.state.activeFileTree ? <FileExplorer root={s.state.activeFileTree} activeFileName={s.activeTab?.name ?? null} onOpenFile={s.handleOpenFile} onOpenFileTransient={s.handleOpenFileTransient} onFileAction={s.state.handleFileAction} onReauthorize={s.handleReauthorize} /> : undefined}
      ...
      />
      <ConsolePanel isOpen={s.isConsoleOpen} logs={s.logs} onClear={() => s.setLogs([])} onToggle={() => s.setIsConsoleOpen()} />
